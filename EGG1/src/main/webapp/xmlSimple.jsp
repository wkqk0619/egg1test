...
for(int i=0; i<lis_E.size(); i++){
	   Element person_E=lis_E.get(i);
 		...
 		<div class="eg">
 			...
 			<div>
 				...
 				<input class="urlinfo" type="text" value="<%=person_E.getChildText("detailurl")%>" name="detailurl" readonly="readonly"/>
 	...
 	<textarea id="alertpr2" hidden="hidden" rows="500" cols="400" readonly="readonly"></textarea>
