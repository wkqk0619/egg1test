...
<head>
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAaSHdRj4Eb_hI5fJOq1Uqor3w1c1TQmXs&libraries=places&callback=initMap"
        async defer></script>
